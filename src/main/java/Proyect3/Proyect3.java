...
public class Proyect3 {
    ...
    public static void main(String[] args) {
        ...
        var ciudad = new Ciudad("Quito","Humberto",1580);
        var provincia = new Provincia("Pichincha",ciudad,1400000,pais);
        ...
        var ciudad2 = new Ciudad("Dakar","Thierry Sabine",1453);
        var provincia2 = new Provincia("Dakar",ciudad2,143000,pais2);
